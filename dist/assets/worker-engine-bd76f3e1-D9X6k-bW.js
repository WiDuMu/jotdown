...
`],{type:`application/javascript`})),{type:`module`}),{wasmUrl:e,logger:n}),s=URL.createObjectURL(new Blob([`async function encodeImage(imageData, imageType, quality) {
...
`],{type:`application/javascript`}));return new a(o,{imageConverter:i(new f(r??2,s,n)),logger:n})}export{p as createPdfiumEngine};